...
output "azurerm_api_management_api_v1_id" {
  value = azurerm_api_management_api.v1.id
}

output "azurerm_api_management_api_v2_id" {
  value = azurerm_api_management_api.v2.id
}
