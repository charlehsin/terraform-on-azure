...
- [Data sources - vault_generic_secret](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/data-sources/generic_secret)
- [Packer - vault Function](https://www.packer.io/docs/templates/hcl_templates/functions/contextual/vault)
